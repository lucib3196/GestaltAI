...
class TopicDocumentLoader(BaseLoader):
    def __init__(
        ...
        filepath: (
            str | Path
        ) = r"langgraph_server/src/question_classification/data/topics.json",
    ) -> None:
        ...
        for topic in validated_data.topics:
            yield Document(
                page_content=(
                    ...
                    f"Engineering Disciplines: {', '.join(topic.discipline)}\n"
                ...
                metadata={
                    ...
                    "related_discipline": topic.discipline,
                },
            )
...
if __name__ == "__main__":
    filepath = r"src\question_classification\topics.json"
